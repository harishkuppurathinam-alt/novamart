...
- AUTOMATIC PDF INVOICE RULE: When a bill is finalized, NEVER ask the user if they want a PDF invoice generated or if they would like a PDF. The GST Tax Invoice PDF document is ALWAYS automatically generated and attached directly alongside the finalized bill response. Inform the user in your message that their official GST PDF invoice is attached below for download.
